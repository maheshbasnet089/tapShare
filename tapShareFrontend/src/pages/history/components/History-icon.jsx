    ...
    <>
      <div className="border-[2px] p-1 rounded-full relative">
        <TbHistory
          ...
          title="view history"
        />
        <div className="absolute -translate-x-[14em] top-5 w-[15em]  font-sans text-white peer-hover:block hover:block z-20 bg-transparent pt-4 hidden">
          <div className="bg-[#2b3b568f] snap-y backdrop-blur-sm rounded px-3 overflow-y-scroll h-[18em] w-full grid grid-cols-1 place-content-start gap-3 py-4">
